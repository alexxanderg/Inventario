...
public class notificaciones extends JInternalFrame implements ActionListener {
	...
	public void ajustarAnchoColumnasPA() {
		...
		tcm.getColumn(0).setPreferredWidth(anchoColumna(55)); // C�digo
	...
	protected void actionPerformedBtnMarcarVendido(ActionEvent e) {
		...
		int opc = 0;
		opc = JOptionPane.showConfirmDialog(null, "Esta acci�n quitar� al producto de esta lista. �Continuar?", "Confirmar", JOptionPane.YES_NO_OPTION,
