...
public class ModificarCliente2 extends JFrame implements ActionListener, WindowListener, KeyListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModificarCliente2 frame = new ModificarCliente2(0, null);
	 ...
	 * Create the frame.
	 */
	public ModificarCliente2(int idcliente, MantenimientoClientes2 mantenimientoCliente) {
		...
		setFocusTraversalPolicy(
				new FocusTraversalOnArray(new Component[] { this.cbTipoDoc, this.txtNroDoc, this.txtNombre,
						this.txtDireccion, this.txtTelefono, this.txtCorreo, this.btnModificar, this.btnCancelar }));
