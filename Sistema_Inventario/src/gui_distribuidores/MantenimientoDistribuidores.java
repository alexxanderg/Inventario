...
public class MantenimientoDistribuidores extends JInternalFrame {
	...
	public MantenimientoDistribuidores(VentanaPrincipal vp) {
		...
		this.scrollPane.setBounds(10, 41, 978, 568);
	...
	public void cargar() {
		...
		tb.setRowHeight(30);
		tb.setModel(dtm);
		dtm.setColumnIdentifiers(new Object[]{"ID", "NOMBRE", "TIPO DOC", "NRO DOCUMENTO", "DIRECCI�N", "PERSONA CONTACTO", "TELEFONO", "CORREO"});
	...
	protected void mouseClickedMnNewMenu_2(MouseEvent e) {
		...
		int opc = JOptionPane.showConfirmDialog(null, "�Seguro de querer eliminar este distribuidor?", "Confirmaci�n", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
		if (opc == 0) {
			consulta.iniciar();
