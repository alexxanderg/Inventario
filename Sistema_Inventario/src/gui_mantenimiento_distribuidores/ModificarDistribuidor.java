...
public class ModificarDistribuidor extends JDialog implements ActionListener, WindowListener, KeyListener {
	...
	MantenimientoDistribuidores mantenimientoUsuarios;
	int idusuario;
	ResultSet rs;
	...
	public static void main(String[] args) {
		try {
			ModificarDistribuidor dialog = new ModificarDistribuidor(0, null);
	...
	public ModificarDistribuidor(int idusuario, MantenimientoDistribuidores mantenimientoUsuarios) {
