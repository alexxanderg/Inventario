...
public class Kardex extends JInternalFrame
{
  ...
  public Kardex(VentanaPrincipal vp) {
    ...
    setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[] { this.txtCodigo, this.chckbxFiltrar, this.txtCodigo2 }));
    ...
    try
    {
      ...
      while (this.rs.next())
      {
        if (this.rs.getInt("estado") == 1) {
          ...
          listProds.add(this.rs.getString("producto") + " " + this.rs.getString("detalles") + " " + this.rs.getString("marca") + " " + this.rs.getString("color") + " " + this.rs.getString("laboratorio"));
  ...
  public void cargarBuscador()
  {
    try {
      ...
      while (rs.next())
        this.ac.addItem(rs.getString("producto") + " " + rs.getString("detalles") + " " + rs.getString("marca") + " " + rs.getString("color") + " " + rs.getString("laboratorio") + " " + rs.getString("lote") + " * " + rs.getString("unimedida") + 
  ...
  protected void keyTypedTxtCodigo(KeyEvent e) { char c = e.getKeyChar();
    if (c == '\n')
  ...
  protected void mouseClickedMnaadirStock(MouseEvent arg0) { String nota = "";
